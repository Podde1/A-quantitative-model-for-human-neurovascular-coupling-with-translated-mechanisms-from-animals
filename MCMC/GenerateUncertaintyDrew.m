function []=GenerateUncertaintyDrew(FolderName,FileName)
...
SPparams = table2array(alldata(:,2:38));  
...
for i = 1:SPsize
    ...
    simoutput = SimulateDrewAll(sampledParameters(i,:)', Constants, stimend, Data, cutoff);
...
save(fullfile(FolderName,'DrewStructs.mat'),'Data','DrewSimulation')
save(fullfile(FolderName,'p_bestDrew.mat'), 'bestParams')
