function [model] = SensoryDesjardins2_syms()
...
u = (am_if(am_lt(t-floor(t),0.1),1,0)    +    am_if(am_lt(t-floor(t),0.43),1,0)*am_if(am_gt(t-floor(t),0.33),1,0)       +     am_if(am_lt(t-floor(t),0.76),1,0)*am_if(am_gt(t-floor(t),0.66),1,0));
