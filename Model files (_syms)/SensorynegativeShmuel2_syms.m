function [model] = SensorynegativeShmuel2_syms()
...
% create parameter syms
syms NOvsm0 PGE2vsm0 NPYvsm0 kCa tstart tend g_1 g_2 g_3 g_s CMRO2_0 CO2_l pO2_femart HbO_0 HbR_0 SaO2_0 ScO2_0 SvO2_0 TE B0 p1 p2 onoff
% create parameter vector 
model.sym.k = [NOvsm0, PGE2vsm0, NPYvsm0, kCa, tstart, tend, g_1, g_2, g_3 ,g_s , CMRO2_0, CO2_l, pO2_femart, HbO_0, HbR_0, SaO2_0, ScO2_0, SvO2_0, TE, B0, p1, p2, onoff];
...
model.sym.xdot(1) = p1*k_u1*u +kPF1*am_min(0,N_Pyr) -kIN*am_min(0,N_NPY) -sinkN_NO*N_NO;     
model.sym.xdot(2) = p2*k_u2*u +kPF2*am_min(0,N_Pyr) -kIN2*am_min(0,N_NO) -sinkN_NPY*N_NPY; 
...
model.sym.y(4) = BOLDfractional;
model.sym.y(5) = CBF;
model.sym.y(6) = BOLDpercentage;
model.sym.y(7) = ky4*(N_Pyr);
model.sym.y(8) = HbTout;
model.sym.y(9) = HbOout;
model.sym.y(10) = HbRout;
end